...
def encrypt_message_into_image(
    ...
    clear_text_message_after_plugboard = cubigma._run_message_through_plugboard(clear_text_message)  # pylint:disable=W0212
    ...
    for i in range(5):
        ...
        encrypted_chunk_after_plugboard = cubigma._run_message_through_plugboard(encrypted_chunk)  # pylint:disable=W0212
